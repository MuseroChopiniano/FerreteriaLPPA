<%@ Page Title="Mi Cuenta" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Manage.aspx.vb" Inherits="Account_Manage" %>
            ...
            <section id="passwordForm">
               <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <asp:Label runat="server" ID="ConfirmNewPasswordLabel" AssociatedControlID="ConfirmNewPassword" CssClass="col-md-2 control-label">Vuelva a ingresar la nueva contraseña</asp:Label>
                            <div class="col-md-10">
