    ...
    Protected Sub Page_Load() Handles Me.Load
        If Not IsPostBack Then
            ...
            If message IsNot Nothing Then
                ...
                SuccessMessageText = If(message = "ChangePwdSuccess", "Su contraseña ha sido reestablecida con éxito.", If(message = "SetPwdSuccess", "Su contraseña ha sido establecida con éxito.", If(message = "RemoveLoginSuccess", "La cuenta fue eliminada con éxito.", [String].Empty)))
